USE EXC3;USE EXC3;
CREATE TABLE jobs(job_id int(50) PRIMARY KEY ,job_title varchar(50),min_salary int(50),max_salary int(50));
CREATE TABLE dependents(dependent_id int(50) PRIMARY KEY ,first_name varchar(50),last_name varchar(50),relationship varchar(50), employee_id varchar(50));
CREATE TABLE departments(department_id int(50) PRIMARY KEY ,department_name varchar(50),location_id varchar(50));
CREATE TABLE regions(region_id int(50) PRIMARY KEY ,region_name varchar(50));
CREATE TABLE countries(country_id int(50) PRIMARY KEY ,country_name varchar(50), region_id varchar(50));
CREATE TABLE locations(location_id int(50) PRIMARY KEY ,street_address varchar(50),postal_code varchar(50),city varchar(50), state_province varchar(50), country_id varchar(50));
CREATE TABLE employees(employee_id int(50) PRIMARY KEY ,first_name varchar(50),last_name varchar(50),email varchar(50), phone_number varchar(50), hire_date varchar(50), job_id varchar(50), salary int(50), manager_id varchar(50), department_id int(50));
desc jobs;
desc dependents;
desc departments;
desc regions;
...
USE EXC3;ALTER TABLE dependents add FOREIGN KEY (employee_id) references employees (employee_id);
USE EXC3;ALTER TABLE dependents add FOREIGN KEY (employee_id) references employees (employee_id);
USE EXC3;ALTER TABLE Dept add FOREIGN KEY (location_id) references locations (location_id);USE EXC3;ALTER TABLE Dept add FOREIGN KEY (location_id) references locations (location_id);
USE EXC3;ALTER TABLE locations add FOREIGN KEY (country_id) references countries (country_id);
USE EXC3;ALTER TABLE countries add FOREIGN KEY (region_id) references regions (region_id);
USE EXC3;ALTER TABLE employees modify column salary smallint;
USE EXC3;ALTER TABLE employees ADD commission varchar(20);
USE EXC3;ALTER TABLE employees modify column hire_date date;
...
SELECT employee_id, first_name, last_name FROM employees WHERE hire_date BETWEEN '1995-01-01' AND '1997-12-31';
SELECT job_id, job_title FROM jobs WHERE max_salary < 5000;
SELECT LOWER(email) AS lowercase_email FROM employees;
SELECT employee_id, first_name, last_name FROM employees WHERE YEAR(hire_date) = 1995;
INSERT INTO employees (employee_id_name, last_name, department_id) VALUES (12345, 'Paul', 'Newton', 11);
